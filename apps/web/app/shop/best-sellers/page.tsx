      ...
      <div className="bg-iv-deep-green/20 border-b border-iv-gold/10 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <p className="text-xl text-iv-cream/70 max-w-3xl leading-relaxed font-light">
            Discover our initial launch phase Hero SKUs. These five essential formulations represent the core of the Chiarelle system—engineered for metabolic precision and luxury performance.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-iv-cream/60 leading-relaxed font-light text-lg mb-8">
                Chiarelle expresses quiet, confident luxury. Every surface is intentional, tactile, and premium. Our 2026 Hero SKUs feature airless systems, rPET cartridges, and real Champagne Gold metal components.
              </p>
