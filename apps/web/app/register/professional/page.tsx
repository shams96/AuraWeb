  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#1A1614' }}>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(160deg, #0F2419 0%, #1F5129 50%, #0D2B20 100%)' }}
      >
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(circle at 80% 20%, rgba(145,56,50,0.10) 0%, transparent 55%)' }} />

        <div className="relative z-10 p-10">
          <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
            <span style={{ fontFamily: 'var(--iv-font-serif)', fontSize: '1rem', fontWeight: 700, color: '#FDFAF5', letterSpacing: '0.12em', textTransform: 'uppercase' }}>Isola Vitale</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              ...
              <div key={b} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div style={{ width: 5, height: 5, borderRadius: '50%', background: '#913832', flexShrink: 0 }} />
        ...
        <div style={{ width: '100%', maxWidth: 440 }}>
          ...
          {success ? (
            <div style={{ textAlign: 'center', padding: '40px 0' }}>
              <CheckCircle2 size={44} style={{ color: '#913832', margin: '0 auto 20px' }} />
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: loading ? 'rgba(145,56,50,0.5)' : '#913832',
