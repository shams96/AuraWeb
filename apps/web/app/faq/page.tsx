...
export const metadata: Metadata = {
  title: 'FAQ',
  description: 'Answers to the most common questions about Chiarel\'s four adaptive protocols, the science of skin vitality, shipping, returns, and the 90-day ritual guarantee.',
}
      ...
      items: [
        {
          ...
          a: 'Metabolic skincare targets the cellular processes that govern skin health, volume, and repair. Unlike traditional skincare which focuses on topical symptoms, Chiarel formulations provide metabolic signals that optimize the cellular engine itself.'
        },
        {
