...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'Complimentary Chiarel Resilience Matrix™ Protocol Certification for your clinical or retail team.',
  },
  {
      ...
      <section className="bg-iv-deep-green/20 border-b border-iv-gold/10 pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <p className="text-xl text-iv-cream/70 max-w-3xl leading-relaxed font-light mb-12">
            Join the Chiarel professional network. Access clinical-grade formulations, industry-leading margins, and the science behind the world's first 4-tier metabolic skincare system.
          </p>
            ...
            <div>
              ...
              <div className="mt-12 p-8 bg-iv-black border border-iv-gold/10 rounded-2xl">
                ...
                <blockquote className="text-iv-cream/70 italic iv-serif text-lg leading-relaxed mb-6">
                  "Chiarel has transformed our clinic's retail performance. The clinical documentation gave our dermatologists confidence, and our clients see measurable results within 6 weeks."
                </blockquote>
