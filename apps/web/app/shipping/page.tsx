        ...
        <div className="space-y-16">
          {regions.map((region) => (
            <div key={region.name} className="p-10 bg-iv-deep-green/10 border border-iv-white/5 rounded-3xl hover:border-iv-gold/20 transition-all group">
              <h2 className="text-2xl font-bold text-iv-white mb-6 uppercase tracking-widest italic">{region.name}</h2>
          ...
          <div className="pt-16 border-t border-iv-white/5 space-y-8">
             ...
             <p className="text-iv-cream/60 leading-relaxed font-light"> All LIRI ROMA products are stabilized and temperature-monitored during transit from our laboratories in Isola del Liri. We utilize premium, low-impact packaging to ensure 100% molecular stability upon arrival. </p>
          </div>
        </div>
      </section>
    </div>
