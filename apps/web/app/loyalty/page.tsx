...
const EARN_ACTIONS = [
  ...
  { action: 'Complete Liri Skin Assessment™', points: '75 pts', note: 'One-time' },
...
export default function LoyaltyPage() {
  ...
  const faqs = [
    ...
    { q: 'Can I gift my points to someone else?', a: 'iv Verde and Oro members can transfer up to 500 points per calendar year to another LIRI ROMA account.' },
